...
const selectInputs = async () =>{
  const { userUTXOs, registryUTXOs, authorizedContractUTXOs } = await getUtxos()
  ...
  console.log(authorizedContractUTXOs)
  ...
  return {
    ...
    auctionUTXOValid,
    auctionUTXOInvalid,
    authorizedContractUTXO: authorizedContractUTXOs[0]
  }
}
